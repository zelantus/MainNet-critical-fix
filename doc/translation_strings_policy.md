...
This document provides guidelines for internationalization of the Zelantus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zelantus_en.ts` remains unchanged.
