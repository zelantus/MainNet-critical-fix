...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://zelantus.com/cfields/osslsigncode-Backports-to-1.7.1.patch
...
space *do not upload these to the zelantus.com server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the zelantus.com server
...
people without access to `zelantus.com` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
zelantus.com (see below for zelantus.com update instructions).

- Update zelantus.com version

  - First, check to see if the Zelantus.org maintainers have prepared a
    release: https://github.com/zelantus-dot-org/zelantus.com/labels/Releases
  ...
  - If they have not prepared a release, follow the Zelantus.org release
    instructions: https://github.com/zelantus-dot-org/zelantus.com#release-notes
...
- Announce the release:
  ...
  - Zelantus Core announcements list https://zelantus.com/en/list/announcements/join/
