Zelantus Core version *2.1.0* is now available!!
==============

  <https://github.com/ZelantusProject/Zelantus/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/ZelantusProject/Zelantus/commits/release_2.1.0>
