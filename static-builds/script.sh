...
find ${DISTNAME}/bin -type f -executable -exec ../zelantus/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../zelantus/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/zelantus/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/zelantus/depends/SDKs/MacOSX10.11.sdk.tar.gz
