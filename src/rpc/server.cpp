...
CAmount AmountFromValue(const UniValue& value, bool p_isZELS)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Zelantus server stopping";
}
...
{
    return "> zelantus-cli " + methodname + " " + args + "\n";
}
