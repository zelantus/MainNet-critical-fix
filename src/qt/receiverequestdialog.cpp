...
#include "config/zelantus-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatZelantusURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ZelantusUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatZelantusURI(info));
}
