...
#include "qt/zelantusamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ZelantusAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_zelantus-qt -platform xcb      # Linux
//     src/qt/test/test_zelantus-qt -platform windows  # Windows
//     src/qt/test/test_zelantus-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ZelantusUnits::formatWithUnit(unit, balance, false, ZelantusUnits::separatorAlways);
    ...
    // Amount input
    ZelantusAmountField* amountInput = receiveCoinsDialog.findChild<ZelantusAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: zelantus:")) != -1);
