...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ZelantusUnits::SeparatorStyle separators=ZelantusUnits::separatorStandard) const;
