...
void WalletView::setZelantusGUI(ZelantusGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? ZelantusGUI::HD44_ENABLED : _walletModel->hdEnabled() ? ZelantusGUI::HD_ENABLED : ZelantusGUI::HD_DISABLED);
