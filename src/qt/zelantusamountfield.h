...
/** Widget for entering zelantus amounts.
  */
class ZelantusAmountField: public QWidget
{
    Q_OBJECT

    // ugly hack: for some unknown reason CAmount (instead of qint64) does not work here as expected
    // discussion: https://github.com/ZelantusProject/Zelantus/pull/5117
    Q_PROPERTY(qint64 value READ value WRITE setValue NOTIFY valueChanged USER true)

public:
    explicit ZelantusAmountField(QWidget *parent = 0);
