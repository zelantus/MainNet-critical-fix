...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ZelantusUnits::ZELS),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(ZelantusUnits::formatWithUnit(unit, balance, false, ZelantusUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ZelantusUnits::formatWithUnit(unit, unconfirmedBalance, false, ZelantusUnits::separatorAlways));
    ui->labelImmature->setText(ZelantusUnits::formatWithUnit(unit, immatureBalance, false, ZelantusUnits::separatorAlways));
    ui->labelTotal->setText(ZelantusUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, ZelantusUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ZelantusUnits::formatWithUnit(unit, watchOnlyBalance, false, ZelantusUnits::separatorAlways));
    ui->labelWatchPending->setText(ZelantusUnits::formatWithUnit(unit, watchUnconfBalance, false, ZelantusUnits::separatorAlways));
    ui->labelWatchImmature->setText(ZelantusUnits::formatWithUnit(unit, watchImmatureBalance, false, ZelantusUnits::separatorAlways));
    ui->labelWatchTotal->setText(ZelantusUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ZelantusUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("ZELS")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the ZELS balance grid from expanding and looking terrible when asset balance is hidden
