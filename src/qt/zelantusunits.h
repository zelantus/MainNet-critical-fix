...
/** Zelantus unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZelantusUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZelantusUnits(QObject *parent);

    /** Zelantus units.
      @note Source: https://en.zelantus.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ZELS,
...
typedef ZelantusUnits::Unit ZelantusUnit;
