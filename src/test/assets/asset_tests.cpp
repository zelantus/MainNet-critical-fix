...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        BOOST_CHECK(!IsAssetNameValid("ZELS", type));
        ...
        BOOST_CHECK(IsAssetNameValid("ZELSSPYDER", type));
        BOOST_CHECK(IsAssetNameValid("SPYDERZELS", type));
        ...
        BOOST_CHECK(IsAssetNameValid("SEZELSOT", type));
