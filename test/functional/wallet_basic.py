...
class WalletTest(ZelantusTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ZELS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 ZELS with subtract fee from amount
        ...
        # Sendmany 10 ZELS with subtract fee from amount
