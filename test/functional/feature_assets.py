...
class AssetTest(ZelantusTestFramework):
    ...
    def big_test(self):
        ...
        zelantus_assets = n0.listassets(asset="RAVEN*", verbose=False, count=2, start=-2)
        assert_equal(len(zelantus_assets), 2)
        assert_equal(zelantus_assets[0], "RAVEN2")
        assert_equal(zelantus_assets[1], "RAVEN3")
        self.sync_all()
