...
import os
import struct
from test_framework.test_framework import ZelantusTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(ZelantusTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that zelantus has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("zelantusd has not been built with zmq enabled.")
