...
By default, zelantusd will dump mempool on shutdown and
...
class MempoolPersistTest(ZelantusTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give zelantusd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent zelantusd from writing mempool.dat to disk. Verify that `savemempool` fails")
