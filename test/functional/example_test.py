...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ZelantusTestFramework
    pass

class ExampleTest(ZelantusTestFramework):
    # Each functional test is a subclass of the ZelantusTestFramework class.
    ...
    def custom_method(self):
        ...
        ZelantusTestFramework class so other tests can use it."""
