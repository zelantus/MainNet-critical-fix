...
class TestZelantusCli(ZelantusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `zelantus-cli getinfo`")
        ...
        self.log.info("Compare responses from `zelantus-cli -getinfo` and the RPCs data is retrieved from.")
