...
class TxnMallTest(ZelantusTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 ZELS:
        ...
        # First: use raw transaction API to send 1240 ZELS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ZELS coin each
        ...
        # Node0's balance should be starting balance, plus 50ZELS for another
        ...
        # Node0's total balance should be starting balance, plus 100ZELS for 
