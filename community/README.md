...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Zelantus that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like zelantusd does for ZELS)
...
* Back-end API platform for Zelantus
    * Other people to hit high-availablity API
* Fee system to pay ZELS fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of ZELS for fees.
...
* #KYC tagger - store info and tag Zelantus addresses
* #ACCREDITED - verify accredited status and tag Zelantus addresses
 
### Technical Consultant
* Help companies apply Zelantus capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional ZELS and asset support


### Areas for Zelantus Innovation
* Financial
